...
<form action="painelAdm.php?adm=usuariosInc" method="post" enctype="multipart/form-data">
<input type="hidden" name="MAX_FILE_SIZE" value="99999999"/>
  ...
  <div class="row">
    ...
    <div class="form-group col-md-2">
      ...
      <select id="perfil" name="usuario[status]" class="form-control">
        <option value ="NA" selected>Escolher...</option>
