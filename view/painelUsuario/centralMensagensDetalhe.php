...
<header>
	<div class="row">
		...
		<div class="col-sm-5 text-right h2">
	    	<a class="btn btn-warning" href="./painelUsr.php?adm=centralMensagensResponder&id=<?php echo $passeio['codPasseio'];?>"><i class="fa fa-pencil"></i></i> Responder</a>
	    	<a class="btn btn-info" href="./painelUsr.php?adm=centralMensagens"><i class="fa fa-backward"></i> Voltar</a>
	    </div>
	</div>
</header>
<hr>
